...
export class AppComponent implements AfterViewInit {
  ...
  public onEvent(e: ScannerQRCodeResult[], action?: any): void {
    ...
    this.scanValue = e[0].value;
    console.log(this.scanValue,"scanned value");
  }
  ...
  public handle(action: any, fn: string): void {
    ...
    if (fn === 'start') {
      action[fn](playDeviceFacingBack).subscribe((r: any) => console.log(fn, r, "scan start"), alert);
    } else {
      action[fn]().subscribe((r: any) => console.log(fn, r, "scan download"), alert);
    }
  }
